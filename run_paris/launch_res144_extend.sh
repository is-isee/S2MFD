...
#
# 使い方:  TAG=res144_kin  bash run_paris/launch_res144_extend.sh
#          TAG=res144_a125 bash run_paris/launch_res144_extend.sh
...
setsid nohup $PY -u run_paris/dynamo7.py 144 96 0 "$YEARS" "${TAG}_b" "$MODE" \
