...
def initial_condition(cfg, grid, setup):
   ...
   n = 0
   time = 0
   return Aph, Bph, time, n, nd

def io(grid, Aph, Bph, time, n, nd):
...
def main_loop(cfg, grid, setup, Aph, Bph, time, dt, n, nd):
   while time < cfg.tend:
      time += dt
      n += 1
...
def run_simulation(cfg):
   ...
   Aph, Bph, time, n, nd = initial_condition(cfg, grid, setup)
   io(grid, Aph, Bph, time, n, nd)
   main_loop(cfg, grid, setup, Aph, Bph, time, dt, n, nd)
   io(grid, Aph, Bph, time, n, nd)
