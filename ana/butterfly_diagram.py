...
# カラーバーを追加
# fig.colorbar(c1, ax=ax1, orientation='vertical').set_label(r'$B_\phi$ (G)', fontsize=30)
...
ax1.set_xlabel('年',fontsize=3*size)
ax2.set_xlabel('年',fontsize=3*size)
ax1.set_ylabel("緯度",fontsize=3*size)
ax2.set_ylabel(r'$B_r$: $r=R_\odot$',fontsize=3*size)
